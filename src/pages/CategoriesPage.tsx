...
const CategoriesPage: React.FC = () => {
  ...
  // Slide diskon carousel diambil dari daftar produk yang sudah dimuat halaman
  // ini — tidak ada request tambahan.
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      {/* Promo yang sama dengan beranda: orang yang masuk lewat /categories
          (dari hasil pencarian, dari link) kalau tidak begini tidak pernah
          melihat penawaran sama sekali. */}
      <PromoCarousel
