    ...
    <div className="relative h-44 md:hidden">
      ...
      <div
        className="
          ...
          tracking-[0.18em] text-[#C73535] backdrop-blur-sm
        "
      >
        ...
        <div className="mx-auto w-full max-w-lg">
          ...
          <div className="mt-5 flex flex-wrap gap-2">
            ...
            <button
              ...
              className="
                inline-flex h-11 items-center justify-center gap-2
                rounded-full border border-[#E8ECF4] bg-white px-6 text-sm
      ...
      <section className="relative hidden min-h-[420px] overflow-hidden md:block">
        ...
        <div
          className="
            ...
            uppercase tracking-[0.18em] text-[#C73535] backdrop-blur-sm
          "
        >
          <span className="h-1.5 w-1.5 rounded-full bg-[#FF4646]" />
          Server error
