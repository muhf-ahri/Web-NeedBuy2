...
import cartImg from '../../assets/Mohon.jpg';

const CartLoginPrompt: React.FC = () => {
          ...
          >
            ...
            <div className="relative h-44 md:hidden">
              ...
              <div className="absolute bottom-3 left-4 flex items-center gap-2 text-[10px] text-white/90">
                <span className="h-1.5 w-1.5 rounded-full bg-[#FFD500]" />
                <span className="truncate">Checkout tinggal satu ketukan</span>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-[1.1fr_0.9fr]">
              ...
              <section className="flex items-center bg-white px-6 py-8 sm:px-8 lg:px-10">
                <div className="mx-auto w-full max-w-md">
                  ...
                  <p className="mt-4 mb-2 text-[10px] font-semibold uppercase tracking-[0.18em] text-[#4077a6]">
                    Area member
                  </p>
                  ...
                  <p className="mt-3 text-center text-[12px] text-[#737686]">
                    Belum punya akun?{' '}
                    <Link to="/register" className="font-semibold text-[#4077a6] hover:underline">
                      Daftar gratis
                    </Link>
                  </p>
                </div>
              ...
              <section className="relative hidden min-h-[420px] overflow-hidden md:block">
                <img
                  src={cartImg}
                  alt="Bebek NeedBuy siap checkout"
                  draggable={false}
                  className="
